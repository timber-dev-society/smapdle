...
const config = {
  groups: [
    { role: 'admin', rules: { z: ALL, player: ALL, incident: ALL, zpanel: ALL, incidentpanel: ALL }},
    { role: 'player', rules: { z: NOTHING, player: READ, incident: NOTHING, zpanel: NOTHING, incidentpanel: NOTHING }},
  ],
  markers: [
    {
      name: 'z',
