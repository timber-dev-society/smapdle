...
const Component = ({ setMenuIsOpen, uid, skin, isHidden, isDead }) => {
  ...
  return (
    <Menu>
      <VList>
        ...
        <VItem visibleIf={!isDead} onClick={() => handler(() => kill(uid))}>
          <FaSkull />
        </VItem>
        <VItem visibleIf={!isDead} onClick={() => setIsSettingOpen(!isSettingOpen)}>
          <FaCog />
